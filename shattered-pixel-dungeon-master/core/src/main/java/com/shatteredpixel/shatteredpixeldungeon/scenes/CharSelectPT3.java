...
public class CharSelectPT3 extends PixelScene {
	...
	public void create() {
		...
		btnNewGame = new GameButton( Messages.get(this, "new") ) {
			...
			protected void onClick() {
				if (GamesInProgress.check( GamesInProgress.curSlot ) != null) {
					CharSelectPT3.this.add(new WndOptions(
							Messages.get(CharSelectPT3.class, "really"),
							Messages.get(CharSelectPT3.class, "warning"),
							Messages.get(CharSelectPT3.class, "yes"),
							Messages.get(CharSelectPT3.class, "no") ) {
						@Override
		...
		Badges.loadingListener = new Callback() {
			@Override
			public void call() {
				if (Game.scene() == CharSelectPT3.this) {
					ShatteredPixelDungeon.switchNoFade( CharSelectPT3.class );
				}
			}
		};
	}
	...
	private class ChallengeButton extends Button {
		...
		protected void onClick() {
			if (Badges.isUnlocked( Badges.Badge.VICTORY )) {
				CharSelectPT3.this.add(new WndChallenges(SPDSettings.challenges(), true) {
				...
				CharSelectPT3.this.add( new WndMessage( Messages.get(CharSelectPT3.class, "need_to_win") ) );
