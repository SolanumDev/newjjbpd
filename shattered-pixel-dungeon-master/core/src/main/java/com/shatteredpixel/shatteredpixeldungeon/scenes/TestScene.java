...
public class TestScene extends PixelScene {
	...
	public void create() {
		...
		Badges.loadingListener = new Callback() {
			@Override
			public void call() {
				if (Game.scene() == TestScene.this) {
					ShatteredPixelDungeon.switchNoFade( TestScene.class );
				}
			}
		};
	}
	...
	private class ChallengeButton extends Button {
		...
		protected void onClick() {
			if (Badges.isUnlocked( Badges.Badge.VICTORY )) {
				TestScene.this.add(new WndChallenges(SPDSettings.challenges(), true) {
				...
				TestScene.this.add( new WndMessage( Messages.get(TestScene.class, "need_to_win") ) );
